...
`rule_version 1` = PR6 合入时的语义，含 R4 的位置约束（B03）与 R7 顶层字符串 `toolUseResult` 的归属证明（B04）；PR6 之前的 v1 快照未部署过，不构成升版事件（控制面 2026-09-12 裁）。
